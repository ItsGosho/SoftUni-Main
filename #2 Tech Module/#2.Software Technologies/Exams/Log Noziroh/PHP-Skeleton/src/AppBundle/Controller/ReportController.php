...
class ReportController extends Controller
{
    ...
    {
        $reports = $this->getDoctrine()->getRepository(Report::class)->find($id);
        $form = $this->createForm(ReportType::class,$reports);
        $form->handleRequest($request);
        return $this->render('report/details.html.twig', ['form'=>$form->createView(), 'report'=>$reports]);
    }
