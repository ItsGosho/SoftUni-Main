 ...
 *
 * Execute the application mainSet using this command (requires PHPUnit to be installed):
 *
...
{
    /**
     * PHPUnit's data providers allow to execute the same mainSet repeated times
     ...
     * publicly accessible. This mainSet ensures that whenever a user tries to
