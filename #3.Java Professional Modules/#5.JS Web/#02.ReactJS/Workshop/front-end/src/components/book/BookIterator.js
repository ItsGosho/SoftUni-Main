...
class BookIterator extends Component {
        ...
        return (
            <div className="card-deck space-top">
                ...
                {topRated.map((movie, index) => {
                    let {_id, title, description, image} = movie;
                    let detailsUrl = RoutingURLs.BOOK.DETAILS.replace(':id', _id);
...
export default bookFetchReduxHoc(BookIterator);