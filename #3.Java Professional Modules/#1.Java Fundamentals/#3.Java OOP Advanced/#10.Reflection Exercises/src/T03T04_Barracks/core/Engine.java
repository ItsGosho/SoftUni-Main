...
public class Engine implements Runnable {
	...
	private String addUnitCommand(String[] data) throws ClassNotFoundException, InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException {
