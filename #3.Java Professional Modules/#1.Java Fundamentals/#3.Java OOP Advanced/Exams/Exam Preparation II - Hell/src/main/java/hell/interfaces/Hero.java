 ...
 *  @method Collection<ItemImp> getItems() - a getter which extracts the items from the Inventory of the Hero
 *  @method void addItem(ItemImp item) - a method which adds an CommonItem to the Inventory of the Hero
...
public interface Hero {
    ...
    Collection<Item> getItems() throws NoSuchFieldException;
