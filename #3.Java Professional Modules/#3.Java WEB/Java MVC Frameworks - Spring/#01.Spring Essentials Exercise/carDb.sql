...
-- Дъмп данни за таблица cardb.cars: ~358 rows (approximately)
/*!40000 ALTER TABLE `cars` DISABLE KEYS */;
INSERT INTO `cars` (`id`, `make`, `model`, `travelled_distance`) VALUES
...
-- Дъмп структура за таблица cardb.customers
DROP TABLE IF EXISTS `customers`;
CREATE TABLE IF NOT EXISTS `customers` (
  `id` bigint(20) NOT NULL,
  `name` varchar(255) NOT NULL,
  `birth_date` datetime NOT NULL,
  `is_young_driver` bit(1) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Дъмп данни за таблица cardb.customers: ~30 rows (approximately)
/*!40000 ALTER TABLE `customers` DISABLE KEYS */;
INSERT INTO `customers` (`id`, `name`, `birth_date`, `is_young_driver`) VALUES
...
-- Дъмп структура за таблица cardb.parts
...
CREATE TABLE IF NOT EXISTS `parts` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK__suppliers` (`supplier_id`),
  CONSTRAINT `FK__suppliers` FOREIGN KEY (`supplier_id`) REFERENCES `suppliers` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Дъмп данни за таблица cardb.parts: ~131 rows (approximately)
/*!40000 ALTER TABLE `parts` DISABLE KEYS */;
INSERT INTO `parts` (`id`, `name`, `price`, `quantity`, `supplier_id`) VALUES
...
-- Дъмп структура за таблица cardb.parts_cars
DROP TABLE IF EXISTS `parts_cars`;
CREATE TABLE IF NOT EXISTS `parts_cars` (
  `part_id` bigint(20) DEFAULT NULL,
  `car_id` bigint(20) DEFAULT NULL,
  KEY `FK__parts` (`part_id`),
  KEY `FK__cars` (`car_id`),
  CONSTRAINT `FK__cars` FOREIGN KEY (`car_id`) REFERENCES `cars` (`id`),
  CONSTRAINT `FK__parts` FOREIGN KEY (`part_id`) REFERENCES `parts` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Дъмп данни за таблица cardb.parts_cars: ~1 170 rows (approximately)
/*!40000 ALTER TABLE `parts_cars` DISABLE KEYS */;
INSERT INTO `parts_cars` (`part_id`, `car_id`) VALUES
	(20, 1),
	(41, 1),
	(67, 1),
	(92, 1),
	...
	(47, 358),
	(131, 358);
/*!40000 ALTER TABLE `parts_cars` ENABLE KEYS */;

-- Дъмп структура за таблица cardb.sales
...
-- Дъмп данни за таблица cardb.sales: ~50 rows (approximately)
/*!40000 ALTER TABLE `sales` DISABLE KEYS */;
INSERT INTO `sales` (`id`, `discount`, `car_id`, `customer_id`) VALUES
	(1, 0.3, 280, 28),
	(2, 0.2, 80, 16),
	(3, 0.4, 356, 29),
	(4, 0.4, 316, 11),
...
-- Дъмп структура за таблица cardb.suppliers
DROP TABLE IF EXISTS `suppliers`;
CREATE TABLE IF NOT EXISTS `suppliers` (
  `id` bigint(20) NOT NULL,
  `name` varchar(255) NOT NULL,
  `is_importer` bit(1) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Дъмп данни за таблица cardb.suppliers: ~31 rows (approximately)
/*!40000 ALTER TABLE `suppliers` DISABLE KEYS */;
INSERT INTO `suppliers` (`id`, `name`, `is_importer`) VALUES
	(1, '3M Company', b'1'),
	(2, 'Agway Inc.', b'0'),
	(3, 'Anthem, Inc.', b'1'),
	(4, 'Airgas, Inc.', b'0'),
