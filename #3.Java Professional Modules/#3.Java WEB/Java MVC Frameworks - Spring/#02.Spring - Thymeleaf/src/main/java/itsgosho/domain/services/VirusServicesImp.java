...
import itsgosho.domain.dtos.VirusCreateDto;
import itsgosho.domain.dtos.VirusEditDto;
...
public class VirusServicesImp implements VirusServices {
    ...
    private boolean saveVirus(Virus virus) {
        try {
            ...
            LoggingService.error("The entity of type `Virus` want't saved: " + ex.getMessage());
        }
        return false;
    }
