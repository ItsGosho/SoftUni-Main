...
public class ControllerLoadingService {
    ...
    public void loadControllerActionHandlers(String applicationClassesFolderPath) throws NoSuchMethodException, IOException, InstantiationException, IllegalAccessException, InvocationTargetException, ClassNotFoundException {
        ...
        ControllerActionPair controllerIndex = this.controllerActionsByRouteAndRequestMethod.get("GET").get("/");
        ControllerActionPair controllerProfile = this.controllerActionsByRouteAndRequestMethod.get("GET").get("/profile");
        this.controllerActionsByRouteAndRequestMethod.get("GET").remove("/");
        this.controllerActionsByRouteAndRequestMethod.get("GET").remove("/profile");
        this.controllerActionsByRouteAndRequestMethod.get("GET").put("/profile",controllerProfile);
        this.controllerActionsByRouteAndRequestMethod.get("GET").put("/",controllerIndex);
        System.out.println(".");
    }
}
