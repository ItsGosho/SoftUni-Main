...
import main.repositories.util.RepositoryActionInvoker;
import main.repositories.util.RepositoryActionResult;
import main.repositories.util.RepositoryActionResultImpl;
...
public abstract class BaseRepository {
    private static final EntityManagerFactory emf =
            Persistence.createEntityManagerFactory("chushka_db");
